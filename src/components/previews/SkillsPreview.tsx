...
const frontend: Tech[] = [
  ...
  },
  {
    ...
    icon: <I c="bg-sky-500/15"><svg viewBox="0 0 32 32" className="h-5 w-5" fill="#38BDF8"><path d="M16 8c-4 0-6.5 2-7.5 6 1.5-2 3.3-2.8 5.3-2.2 1.1.3 1.9 1.2 2.8 2.1C20 15.4 21.6 17 25.4 17c4 0 6.5-2 7.5-6-1.5 2-3.3 2.8-5.3 2.2-1.1-.3-1.9-1.2-2.8-2.1C21.4 9.6 19.8 8 16 8zM8.5 17c-4 0-6.5 2-7.5 6 1.5-2 3.3-2.8 5.3-2.2 1.1.3 1.9 1.2 2.8 2.1C10.6 24.4 12.2 26 16 26c4 0 6.5-2 7.5-6-1.5 2-3.3 2.8-5.3 2.2-1.1-.3-1.9-1.2-2.8-2.1C13.9 18.6 12.3 17 8.5 17z" /></svg></I>
  },
  {
    name: 'Framer Motion', tip: 'Production animations',
    icon: <I c="bg-indigo-500/15"><svg viewBox="0 0 32 32" className="h-5 w-5"><path d="M6 6h20v6.7H16L6 6zm0 6.7h10l10 6.6H16l-10 6.7V12.7z" fill="#6366F1" /><path d="M6 19.3l10-6.6h10v6.6H16L6 26V19.3z" fill="#818CF8" /></svg></I>
  },
  {
    name: 'shadcn/ui', tip: 'Radix-based component library',
    icon: <I c="bg-foreground/10"><svg viewBox="0 0 32 32" className="h-5 w-5 text-foreground/70" stroke="currentColor" fill="none" strokeWidth="2.5"><line x1="6" y1="26" x2="26" y2="6" /><line x1="6" y1="18" x2="18" y2="6" /></svg></I>
  },
];
...
const backend: Tech[] = [
  ...
  },
  {
    ...
    icon: <I c="bg-foreground/10"><svg viewBox="0 0 32 32" className="h-5 w-5"><path d="M16 2C8.8 2 3 7.8 3 15s5.8 13 13 13 13-5.8 13-13S23.2 2 16 2z" fill="#13AA52" /><path d="M16.3 8c-.1 1-.2 2-.5 2.9-.5 1.5-1.3 2.8-2 4.2-.4.7-.4 1.4-.2 2.2.5 1.7 1 3.4 1.5 5.1.1.3.2.6.2.8h.6c.1-.5.2-1 .3-1.5.2-.6.1-1.1-.2-1.6-.1-.3-.1-.5 0-.8.5-1.6 1-3.2 1.3-4.9.2-1.1.1-2.2-.2-3.3-.3-1-.6-2-.8-3.1z" fill="#fff" /></svg></I>
  },
  {
