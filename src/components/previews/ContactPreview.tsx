...
const ContactPreview = () => {
  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden !py-3 sm:!py-4 md:!py-5">
      <div ref={ref} className="relative">
        ...
        >
          ...
          <p className="mx-auto mt-1.5 max-w-sm text-[10px] leading-relaxed text-muted-foreground sm:text-[11px]">
          ...
          <button
            ...
            className="group mt-4 inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-[10px] font-semibold text-background shadow-[0_6px_20px_hsl(var(--foreground)/0.1)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_28px_hsl(var(--foreground)/0.16)] sm:text-[11px]"
          >
            Send a message
